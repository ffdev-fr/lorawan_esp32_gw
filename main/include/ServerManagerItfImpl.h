 ...
 * @date     15/04/2018
 *
 * @brief    Structures and definitions for 'IServerManager' interface implementation.
 *
 * @details  Used by objects implementing the interface and for the implementation of the
 *           interface object.
*********************************************************************************************/

#ifndef SERVERMANAGERITFIMPL_H
#define SERVVERMANAGERITFIMPL_H
...
/********************************************************************************************* 
  ...
  Pointers to these methods are registered in the 'IServerManagerItfImpl' object by the
...
typedef bool (*ServerMessageEvent)(void *pOwnerObject, void *pEvent);
...
typedef struct _CServerManagerItfImpl
{
  // Public
  AddRef m_pAddRef;
  ...
  Start m_pStart;
  Stop m_pStop;
  ServerMessageEvent m_pServerMessageEvent;

} CServerManagerItfImplOb;

typedef struct _CServerManagerItfImpl * CServerManagerItfImpl;
